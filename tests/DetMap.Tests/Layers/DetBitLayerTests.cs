...
public class DetBitLayerTests
{
    [Fact]
    public void Default_AllFalse()
    {
        var layer = new DetBitLayer("walkable", 8, 8);
    ...
    {
        var a = new DetBitLayer("a", 8, 8);
        var b = new DetBitLayer("b", 8, 8);
        var r = new DetBitLayer("r", 8, 8);
        a.Set(2, 2, true); b.Set(2, 2, true);
        DetBitLayer.And(a, b, r);
    ...
    public void Memory_256x256_UsesOnly1KB()
    {
        ...
        var layer = new DetBitLayer("big", 256, 256);
